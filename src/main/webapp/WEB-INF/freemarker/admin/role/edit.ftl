                ...
                <div class="box-body">
                    <form class="form-horizontal" id="roleInfo" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text"  id="name" placeholder="用户名" name="name" validate="required" value="${role.name}"><span class="red">*</span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label">角色编码</label>
                            <div class="col-sm-8">
                                <input type="text"  id="code" placeholder="用户名" name="code" validate="required" value="${role.code}"><span class="red">*</span>
                            </div>
                        </div>
                        <div>
