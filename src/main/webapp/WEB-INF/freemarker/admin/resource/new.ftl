...
<html>
<head lang="en">
    <@template.head title="权限新增"></@template.head>
        ...
        <div class="box-body">
            <form class="form-horizontal" id="resInfo" method="post">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" id="name" placeholder="权限名称" name="name" validate="required"><span
                            class="red">*</span>
                    </div>
                </div>
                <div class="form-group">
                    <label for="username" class="col-sm-2 control-label">权限编码</label>
                    <div class="col-sm-8">
                        <input type="text" id="code" placeholder="权限编码" name="code" validate="required"><span
                            class="red">*</span>
                    </div>
                </div>
            </form>
