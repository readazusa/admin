                ...
                <div class="box-body">
                    <form class="form-horizontal" id="userInfo" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text"  id="username" placeholder="用户名" name="username" validate="required" value="${user.username?default("")}"><span class="red">*</span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="name" placeholder="姓名" name="name" validate="required" value="${user.name}">
                            </div>
                            <span class="red"></span>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="mobile" placeholder="手机号" validate="mobilenum" name="mobile" value="${user.mobile?default("")}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="birthday" class="col-sm-2 control-label">生日</label>
                            <div class="col-sm-8">
                                <input type="text" class="laydate-icon" id="birthday" placeholder="生日" style="box-sizing: inherit;" name="birthday" value="${user.birthday?string('yyyy-MM-dd HH:mm:ss')}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="email" placeholder="邮箱" validate="email" name="email" value="${user.email?default("")}">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="address" placeholder="地址" style="box-sizing: inherit;" name="address" value="${user.address?default("")}">
                            </div>
                        </div>
                        <div>
