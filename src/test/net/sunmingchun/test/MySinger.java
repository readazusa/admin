...
//
//        jobExecutor .start();   //开启一个任务
        RepositoryService repositoryService = processEngine.getRepositoryService();
        Deployment deployment = repositoryService.createDeployment().addClasspathResource("activiti/mySinger.bpmn").deploy();
...
//        runtimeService.startProcessInstanceByKey("mySinger");
//        processEngine.getProcessEngineConfiguration().getJobExecutor().start();  //开启一个任务
